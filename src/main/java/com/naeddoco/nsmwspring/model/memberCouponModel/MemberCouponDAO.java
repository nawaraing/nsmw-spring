...
public class MemberCouponDAO {
	...
	private static final String SELECTALL_MY_COUPON = "SELECT MC.MEMBER_COUPON_ID , "
											+ "MC.COUPON_ID, "
											+ "MC.COUPON_USAGE, "
											+ "C.COUPON_NAME,"
											+ "C.EXPIRATION_DATE, "
											...
											+ "LEFT JOIN WON_COUPON W "
												+ "ON C.COUPON_ID =W.COUPON_ID "
											+ "LEFT JOIN PERCENTAGE_COUPON P "
												+ "ON C.COUPON_ID = P.COUPON_ID "
											+ "WHERE MC.MEMBER_ID = ? "
											+ "ORDER BY MC.COUPON_USAGE ASC, C.EXPIRATION_DATE ASC";
