...
public class CouponDTO {
    ...
    private int ancDiscountAmount;      		// 원화 쿠폰 할인액
    private int ancMinOrderAmount;      		// 원화 쿠폰 최소 구매 금액
    private int ancPercentageCouponID; 			// 퍼센트 쿠폰 타입 아이디
    private int ancDiscountRate;        		// 퍼센트 쿠폰 할인율
    private int ancMaxDiscountAmount;   		// 퍼센트 쿠폰 최대 할인 금액
