...
public class ProductDetailController {
    ...
    public String getProductDetail(@RequestParam("productID") int productID, Model model, HttpSession session) {
		...
		//----------------------------------------------- 상단 제품 출력 ↓ -----------------------------------------------
				...
				if(broughtProductList.size() == 0) { // 구매 내역이 없을 경우
					...
					System.out.println("3번 반환");
					System.out.println("3번 반환 : " + filteredList);
