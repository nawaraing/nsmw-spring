			...
			<div class="navbar-nav mx-auto">
				<div class="container px-0">
					<nav class="navbar navbar-light bg-white navbar-expand-xl">
						<div class="collapse navbar-collapse bg-white" id="navbarCollapse">
							<div class="navbar-nav mx-auto">
								<a href="/user/checkUserPasswordPage?where=modifyUserInfo"
									class="nav-item nav-link">개인정보수정</a> <a
									href="/user/checkUserPasswordPage?where=modifyUserPassword"
									class="nav-item nav-link">비밀번호변경</a> <a
									href="/user/buyInfoPage" class="nav-item nav-link">구매내역</a> <a
									href="/user/reviewInfoPage" class="nav-item nav-link">리뷰내역</a>
								<a href="/user/couponInfoPage" class="nav-item nav-link">쿠폰관리</a>
							</div>
						</div>
					</nav>
				</div>
